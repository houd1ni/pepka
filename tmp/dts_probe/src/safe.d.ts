...
export declare const ifElse: (...args: import("../types").AnyArgs) => any;
...
export declare const when: (...args: import("../types").AnyArgs) => any;
...
export declare const flip: <T extends AnyFunc>(fn: T) => {
    (a: import("./curry").Placeholder, b: Parameters<T>[0]): (a: Parameters<T>[1]) => any;
    (a: Parameters<T>[1], b: import("./curry").Placeholder): (b: Parameters<T>[0]) => any;
...
export declare const add: {
    (a: import("./curry").Placeholder, b: number): (a: number) => number;
    (a: number, b: import("./curry").Placeholder): (b: number) => number;
...
export declare const gt: {
    (a: import("./curry").Placeholder, b: number): (a: number) => boolean;
    (a: number, b: import("./curry").Placeholder): (b: number) => boolean;
...
export declare const callFrom: (...args: import("../types").AnyArgs) => any;
...
export declare const path: {
    (_path: (string | number)[], o: import("../types").AnyObject): any;
    (_path: (string | number)[]): (o: import("../types").AnyObject) => any;
};
...
export { isNil, isNull, isUndef, isNum, isStr, isObj, isArray, isFunc } from './utils';
/** Alias of identity. Returns the argument unchanged. */
export declare const mirror: typeof identity;
/** Alias of identity. Returns the argument unchanged. */
export declare const reflect: typeof identity;
/** Alias of identity. Returns the argument unchanged. */
export declare const echo: typeof identity;
/** Alias of complement. Returns a negated version of the predicate.
 * @param fn Predicate function to negate.
 */
export declare const notf: typeof complement;
 ...
 */
export declare const weakEq: import("../types").T_eq;
