import { AnyObject } from './types/base.js';
import type { T_qappend, T_qassoc, T_qassocPath, T_qfilter, T_qmap, T_qmapKeys, T_qmapObj, T_qmergeShallow, T_qomit, T_qoverProp, T_qpick, T_qprepend, T_qreduce, T_qslice, T_qsort, T_quniqWith } from './types/quick.js';
...
export declare const qmergeDeep: {
    (a: import("./curry.js").Placeholder, b: AnyObject): (a: AnyObject) => AnyObject;
    (a: AnyObject, b: import("./curry.js").Placeholder): (b: AnyObject) => AnyObject;
